<?php
session_start();
if (!isset($_SESSION['superadmin_id'])) { // Ganti ke superadmin_id jika ini untuk superadmin/jadwal/index.php
...
$superadmin_name = htmlspecialchars($_SESSION['superadmin_name'] ?? 'SuperAdmin'); // Ganti ke superadmin_name
